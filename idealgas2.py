#Write a program that interactively asks the user for values of any two of p, V and T
#and uses the ideal gas law to calculate the quantity they didn't give. (Assigment week 3)
main_loop = 1
